				...
				<div class="inner">
					<div id="flexgrid">
						<div>
							...
							<p>Get yourself a complete pre-built system.</p>
							<ul class="actions">
					...
					<div class="grid-style">
						...
						<div>
							<div class="box">
								...
								<div class="content">
									<header class="align-center">
										<h2>Pre-built systems</h2>
										<p>Best price and performance</p>
									</header>
									<hr />
									<p> We use only the best components from reliable and trusted vendors. These systems are carefully picked and built for maximum performance, reliabilty and price.</p>
								</div>
							</div>
						</div>
						...
						<div>
							<div class="box">
								...
								<div class="content">
									<header class="align-center">
										<h2>Custom built systems</h2>
										<p>Make it the way u want it.</p>
									</header>
									<hr />
									<p> We provide an easy to use system for you to select your system and we will put it all together.</p>
								</div>
							</div>
						</div>
